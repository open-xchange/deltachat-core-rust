...
fn def_port2opt(port: i32) -> Vec<ServerOption> {
        ...
        let success = match step_counter {
            ...
            */
            ...
            14 => {
                ...
                let user_options = if !param.srv_params[Service::Imap as usize].user.is_empty() {
                    vec![param.srv_params[Service::Imap as usize].user.clone()]
                } else {
                    user_options.clone()
                };
            ...
            15 => {
                ...
                let user_options = if !param.srv_params[Service::Smtp as usize].user.is_empty() {
                    vec![param.srv_params[Service::Smtp as usize].user.clone()]
                } else {
                    user_options.clone()
                };
